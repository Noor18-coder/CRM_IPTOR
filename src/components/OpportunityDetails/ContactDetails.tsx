                ...
                <div className="card-body">
                    <div className="name-add-sec">
                        ...
                        <p className="contact-address">
                            {data.visitingAddress ? data.visitingAddress : '--'}
                        </p>
                    </div>
                    <a className="address-card-close" onClick={removeContact}><Image className="card-delete" height="20" src={ImageConfig.DEL_ICON}  /></a>


                    <div className="select-opportunity-sec">
                        <div className="form-group">
                            <label >Select Opportunity Role</label>
                            <select className="form-control opportunity-dd" id="contact" value={opportunityRole} multiple={false} onChange={changeRole}>
                                {
