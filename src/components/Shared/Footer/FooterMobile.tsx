        ...
        <section className="iptor-sticky-footer">
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className={page == 3 ? className + " active-menu" : className}><img src={page === 3 ? ImageConfig.NAV_REPORTS_ACTIVE_ICON : ImageConfig.NAV_REPORTS_ICON} alt="Reports" title="Reports" /></div>
